# Overview
Leveraging state-of-the-art AI models using Intel's OpenVINO™ and oneAPI toolkits to develop a custom transfer learning model to diagnose the severity of Knee Osteoarthritis, followed by improvising available health-tech.

## The Idea
![Knee Osteoarthritis Diagnosis](https://github.com/user-attachments/assets/dca45394-054f-4621-ba14-9b2d4c4847b6)
...
![AI Technologies](https://github.com/user-attachments/assets/85d22461-720d-4320-beaf-e78128cd658d)

## Tech Stack
![Tech Stack](https://github.com/user-attachments/assets/0dfda760-00df-4b0b-8c0d-a31ba07407ad)

# Main Components
## 1. Retrieval Augmented Generation based LLM Chatbot for Medical Consultation
- **Models**: Qwen 2.5 0.5B Instruct, Qwen 2.5 14B Instruct
...
## 3. ResNet-based Image Classification with PyTorch Optimization & OpenVINO
- **Model**: ResNet
- **Framework**: PyTorch
- **Optimization**: OpenVINO
...
# Other Files
- [Knee_OA_Prediction Repository](https://github.com/sabithapaulraj/Knee_OA_Prediction)
- [Cura_Structure_Extraction Repository](https://github.com/sabithapaulraj/Cura_Structure_Extraction)

# Front End
![Front End 1](https://github.com/user-attachments/assets/87d99e76-9e3b-404c-a898-d3ae7101722e)
![Front End 2](https://github.com/user-attachments/assets/d7beb37a-39e7-4a35-b756-3a48fe732c88)
![Front End 3](https://github.com/user-attachments/assets/cbff450d-3f09-411a-bf7d-41380a078205)
![Front End 4](https://github.com/user-attachments/assets/7aabb563-cafe-40c6-8091-936b917e809d)
![Front End 5](https://github.com/user-attachments/assets/4e5a1396-774d-4a4c-9d41-852d36eabd1f)
